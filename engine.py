...
from car_eval import _write_car_results_file, _do_car_python_eval
import utils
...
@torch.no_grad()
def car_evaluate(model, data_loader, device):
    ...
    if utils.is_main_process():
        ...
        _write_car_results_file(all_boxes, image_index, data_loader.dataset.root,
                                data_loader.dataset._transforms.transforms[0].CLASSES)
        _do_car_python_eval(data_loader)
