...
path = '../요가영상/video_01_frame'
order = [i for i in range(1, int(frame_count//frame_div) + 1)]

for file_nbr in order:
    image_name = 'frame' + str(file_nbr) + '.jpg'
    print(image_name)
