...
def parse_opt():
    ...
    weights_path = "weights/chatbot"
    save_pt = "model.pt"

    source_path = default_path + "ai_data/chatbot/csv_data/"
    ...
    parser.add_argument('--model-name', type=str, default="Comb", help='select model')
...
def main(opt):
    ...
    classes = ["unknown", "hello", "manual", "title", "actor", "director", "rank", "year", "country", "setting"]
