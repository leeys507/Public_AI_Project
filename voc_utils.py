...
class VOCDetection(torchvision.datasets.VOCDetection):
    def __init__(self, img_folder, year, image_set, download, transforms):
        print(img_folder, year, image_set, download, transforms)
...
def get_voc(root, image_set, transforms, download=False):
    ...
    dataset = VOCDetection(img_folder=root, year='2007', image_set=image_set, download=download, transforms=transforms)
